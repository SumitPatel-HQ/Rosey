...
import {
  Users, Mail, Clock, MessageSquare, CheckCircle,
  XCircle, Reply, TrendingUp,
} from "lucide-react";
        ...
        <Card className="mt-6">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              {analytics.emailsSkipped} email{analytics.emailsSkipped !== 1 ? "s" : ""} were
              skipped because Gmail/OpenAI credentials are not configured.
            </p>
          </CardContent>
        </Card>
      )}
